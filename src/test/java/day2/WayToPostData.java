...
//	    }
		...
		.then()
			.statusCode(201)
			.body("name",equalTo("Private Kovienko2"))
			.body("location", equalTo("Stalingrade"))
			.body("phone",equalTo("1111111111"))
			.body("courses[0]",equalTo("Sniper"))
			.body("courses[1]",equalTo("Sub_machine_gunner"))
			.header("Content-Type","application/json; charset=utf-8")
...
//			.delete("http://localhost:3000/student_record/"+i)
			.delete("http://localhost:3000/student_record/8")
